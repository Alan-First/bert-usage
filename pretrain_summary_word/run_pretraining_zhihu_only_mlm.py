...
flags.DEFINE_string(
    "input_dir", None,
    "Input TF example dir (can be a glob or comma separated).")
...
flags.DEFINE_integer("max_eval_steps", 1000000, "Maximum number of eval steps.")
...
#--do_train=True \
#--do_eval=False \ --bert_config_file=./chinese_L-12_H-768_A-12/bert_config.json \
...
def main(_):
  ...
  input_files = [os.path.join(input_dir, input_file) for input_file in input_file_list]
