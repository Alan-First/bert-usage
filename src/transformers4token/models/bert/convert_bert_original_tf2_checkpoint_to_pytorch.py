...
python convert_bert_original_tf2_checkpoint_to_pytorch.py
...
# --tf_checkpoint_path="/data/search_opt_model/topk_opt/chinese_L-12_H-768_A-12/bert_model.ckpt" \
# --bert_config_file="/data/search_opt_model/topk_opt/chinese_L-12_H-768_A-12/bert_config.json" \
# --pytorch_dump_path="/data/search_opt_model/chinese_L-12_H-768_A-12_pretrain_pytorch/pytorch_model.bin"
...
def load_tf2_weights_in_bert(model, tf_checkpoint_path, config):
    ...
    for full_name, shape in init_vars:
        # logger.info(f"Loading TF weight {full_name} with shape {shape}")
        print(f"Loading TF weight {full_name} with shape {shape}")
        if full_name.startswith("cls/"):
            continue
