...
cd /data/xiaoyichao/projects/DistilBERT/examples/research_projects/distillation
...
python train.py \
    ...
    --token_counts data/token_counts.bert-base-chinese.pickle \
    --force
...
python train.py \
    ...
    --alpha_ce 5.0 --alpha_mlm 2.0 --alpha_cos 1.0 --alpha_clm 0.0 --mlm \
    --freeze_pos_embs \
    --dump_path serialization_dir/my_2_layer_training \
    --data_file data/binarized_text.bert-base-chinese.pickle \
    --token_counts data/token_counts.bert-base-chinese.pickle \
    --student_pretrained_weights /data/xiaoyichao/projects/DistilBERT/examples/research_projects/distillation/serialization_dir/tf_bert-base-uncased_0247911.pth \
    --force
...
python train.py \
    ...
    --alpha_ce 5.0 --alpha_mlm 2.0 --alpha_cos 1.0 --alpha_clm 0.0 --mlm \
    --freeze_pos_embs \
    --dump_path serialization_dir/my_2_layer_training_sample \
    --data_file data/binarized_text_sample.bert-base-chinese.pickle \
    --token_counts data/token_counts_sample.bert-base-chinese.pickle \
    --student_pretrained_weights /data/xiaoyichao/projects/DistilBERT/examples/research_projects/distillation/serialization_dir/tf_bert-base-uncased_0247911.pth \
    --force
...
nohup python -u train.py \
    ...
    --freeze_pos_embs \
    --batch_size 50 \
    --dump_path serialization_dir/my_2_layer_training_hhz \
    --data_file data/binarized_text.bert-base-chinese.pickle \
    --token_counts data/token_counts.bert-base-chinese.pickle \
    --student_pretrained_weights /data/xiaoyichao/projects/DistilBERT/examples/research_projects/distillation/serialization_dir/tf_bert-base-uncased_20220928.pth \
    --force > train.out 2>&1 &


python -u train.py \
    --student_type distilbert \
    --student_config /data/search_opt_model/topk_opt/distilbert/training_configs/distilbert-base-chinese.json \
    --teacher_type bert \
    --teacher_name bert-base-chinese \
    --alpha_ce 5.0 --alpha_mlm 2.0 --alpha_cos 1.0 --alpha_clm 0.0 --mlm \
    --freeze_pos_embs \
    ...
    --dump_path  /data/search_opt_model/topk_opt/distilbert/distilbert_torch \
    --data_file /app/distilbert/examples/research_projects/distillation/data/binarized_text.bert-base-chinese.pickle \
    --token_counts /app/distilbert/examples/research_projects/distillation/data/token_counts.bert-base-chinese.pickle \
    --student_pretrained_weights /data/search_opt_model/topk_opt/distilbert/serialization_dir/tf_bert-base-uncased_20220928.pth \
    --force
    
# overwrites the `dump_path` if it already exists.
"""
import argparse
import json
import os
...
from transformers4token import (
    BertConfig,
    BertForMaskedLM,
    BertTokenizer,
    DistilBertConfig,
...
def sanity_checks(args):
    ...
    print("args.student_config=",args.student_config)
...
def main():
    ...
    args.max_model_input_size = tokenizer.max_model_input_sizes["bert-base-multilingual-cased"]
    ...
    # teacher = teacher_model_class.from_pretrained("/data/search_opt_model/chinese_L-12_H-768_A-12_pretrain_pytorch", output_hidden_states=True)
    if args.n_gpu > 0:
    ...
    # SANITY CHECKS #
    print((student.config.vocab_size))
...
if __name__ == "__main__":
    ...
    main()
    # send_msg("distilbert 完成。Let's go get some drinks.")
